...
typedef enum EXDebugComponent {
    ...
    /* General protocol */
    EXDBGCOMP_GENERAL                   = 0x00000001,
    EXDBGCOMP_FACEBOOK                  = 0x00000002,
    EXDBGCOMP_PARSE                     = 0x00000004,
...
#define EXDBGCOMP_STR_MODEL              "GENERAL"
#define EXDBGCOMP_STR_RENDER             "FACEBOOK"
#define EXDBGCOMP_STR_PURCHASE           "PARSE"
